...
HPCA = HPCA_decomposition(data = data, out1 = func, out2 = long, 
                   out3 =reg)  # HPCA_decomposition.R
...
boot_p = HPCA_bootstrap(B = 200, func = func, long = long, reg = reg, 
                        HPCA, region = 5, D = 2, N = c(15, 15), 
                        K= 3, L = 3, M = 3)  # HPCA_bootstrap.R
...
persp(fbps(mu_hat,knots=3)$Yhat, col = "red", theta = -45,  
      expand = 0.8, r = 4 , main = "Estimated mean function",
      xlab = "functional", ylab = "longitudinal", zlab = "")

# Plot group-region shift (group = 1, region = 1)
par(mfrow = c(1, 2))
persp(eta[[1]][[1]], col = "blue", theta = 45,  expand = 0.8, 
      r = 2 , main = "True group-region shift",
      xlab = "functional", ylab = "longitudinal", zlab = "")
persp(fbps(eta_hat[[1]][[1]],knots=3)$Yhat, col = "red", theta = 45, 
